...
| Reference loading | Auto-loaded by plugin | cat ~/.gemini/skills/pipeline/references/*.md |
...
All 12 pipeline type definitions are in `~/.gemini/skills/pipeline/references/pipelines/`:
