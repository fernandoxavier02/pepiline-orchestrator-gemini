...
Load at start:
```
run_shell_command: cat ~/.gemini/skills/pipeline/references/team-registry.md
run_shell_command: cat ~/.gemini/skills/pipeline/references/complexity-matrix.md
```

Load once pipeline is selected:
```
run_shell_command: cat ~/.gemini/skills/pipeline/references/pipelines/{type}-{variant}.md
```
...
All definitions in `~/.gemini/skills/pipeline/references/pipelines/`.
...
ORCHESTRATOR_PIPELINE_DECISION:
  ...
  decisao:
    ...
    pipeline_reference: "~/.gemini/skills/pipeline/references/pipelines/[type]-heavy.md"
  instrucoes_executor:
...
ORCHESTRATOR_PIPELINE_DECISION:
  ...
  pipeline:
    ...
    reference: "~/.gemini/skills/pipeline/references/pipelines/[type]-heavy.md"
  instrucoes_executor:
...
Reference: ~/.gemini/skills/pipeline/references/pipelines/[name].md
