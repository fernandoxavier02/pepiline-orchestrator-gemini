...
reference_checklist: "run_shell_command: cat ~/.gemini/skills/pipeline/references/checklists/auth.md"
```
...
reference_checklist: "run_shell_command: cat ~/.gemini/skills/pipeline/references/checklists/input-validation.md"
```
...
reference_checklist: "run_shell_command: cat ~/.gemini/skills/pipeline/references/checklists/data-integrity.md"
```
...
reference_checklist: "run_shell_command: cat ~/.gemini/skills/pipeline/references/checklists/error-handling.md"
```
