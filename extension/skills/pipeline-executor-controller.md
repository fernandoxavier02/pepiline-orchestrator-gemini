...
Load full reference: `run_shell_command: cat ~/.gemini/skills/pipeline/references/complexity-matrix.md`
...
Based on the team resolved in Step 0, execute the appropriate inline sequence. Load team registry for reference: `run_shell_command: cat ~/.gemini/skills/pipeline/references/team-registry.md`
