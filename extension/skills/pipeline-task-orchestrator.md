...
```
run_shell_command: cat ~/.gemini/skills/pipeline/references/pipelines/{variant}.md
```
...
2. Load sentinel integration reference:
   ```
   run_shell_command: cat ~/.gemini/skills/pipeline/references/sentinel-integration.md
   ```
